 ...
 */	 
	public class AutoFitArea extends Shape {
		 ...
		 * 				<ul>
		 * 					<li><b>scaleMode : String</b> - Determines how the target should be scaled to fit the area. Use the ScaleMode class constant: <code>STRETCH, PROPORTIONAL_INSIDE, PROPORTIONAL_OUTSIDE, NONE, WIDTH_ONLY,</code> or <code>HEIGHT_ONLY</code></li>
		 * 					<li><b>hAlign : String</b> - Horizontal alignment of the target inside the area. Use the AlignMode class constant: <code>LEFT</code>, <code>CENTER</code>, and <code>RIGHT</code>.</li>
		 * 					<li><b>vAlign : String</b> - Vertical alignment of the target inside the area. Use the AlignMode class constant: <code>TOP</code>, <code>CENTER</code>, and <code>BOTTOM</code>.</li>
